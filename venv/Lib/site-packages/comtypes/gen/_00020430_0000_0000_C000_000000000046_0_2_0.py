...
IFontDisp = Font
__all__ = [ 'Color', 'OLE_HANDLE', 'IPicture', 'IFont',
           'OLE_YPOS_HIMETRIC', 'FONTUNDERSCORE', 'OLE_YPOS_PIXELS',
           'FONTNAME', 'IFontEventsDisp', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_PIXELS', 'OLE_YSIZE_PIXELS', 'Picture',
           'OLE_COLOR', 'VgaColor', 'IFontDisp', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'StdFont', 'StdPicture',
           'OLE_XSIZE_HIMETRIC', 'OLE_TRISTATE', 'FontEvents',
           'FONTSTRIKETHROUGH', 'Font', 'Unchecked',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'FONTITALIC', 'OLE_YSIZE_CONTAINER',
           'IPictureDisp', 'OLE_XPOS_CONTAINER',
           'LoadPictureConstants', 'OLE_XSIZE_CONTAINER',
           'Monochrome', 'Checked', 'FONTSIZE', 'OLE_CANCELBOOL',
           'OLE_XPOS_PIXELS', 'Gray', 'Default']
